  ...
  return (
    <main className="min-h-screen pt-20 relative overflow-hidden">
      ...
      <div className="max-w-10/12 mx-auto px-4 relative z-10">
        ...
        {/* Title */}
        <h1 className="kurdish-text text-center text-4xl font-semibold py-4 text-violet-500">
          فیلمەکان
        </h1>
            ...
            <div className="grid grid-cols-6 gap-4">
              {filtered.map((m, index) => (
                <Link key={m.id} href={`/movies/${m.slug}`}>
                  <div 
                    className="group relative bg-white/5 rounded-lg overflow-hidden shadow-sm hover:scale-105 transition duration-200 cursor-pointer animate-pop-in"
                    style={{
