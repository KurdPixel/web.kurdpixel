    ...
    <section className="pt-28">
      <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
        ...
        <div className="mx-auto mb-8 max-w-screen-sm lg:mb-16">
          <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">ستافی <span className="text-violet-500">کوردپیکسڵ</span></h2>
        ...
        <div className="grid gap-8 lg:gap-16 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
          ...
          <div className="text-center text-gray-500 dark:text-gray-400">
            ...
            <ul className="flex justify-center mt-4 space-x-4">
              <li><a href="#" className="text-[#39569c] hover:text-gray-900 dark:hover:text-white">{/* icon */}</a></li>
              <li><a href="#" className="text-[#00acee] hover:text-gray-900 dark:hover:text-white">{/* icon */}</a></li>
            </ul>
          </div>
